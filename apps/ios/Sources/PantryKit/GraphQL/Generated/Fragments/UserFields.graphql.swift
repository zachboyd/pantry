...
public extension PantryGraphQL {
  struct UserFields: PantryGraphQL.SelectionSet, Fragment {
    public static var fragmentDefinition: StaticString {
      #"fragment UserFields on User { __typename id auth_user_id email first_name last_name display_name avatar_url phone birth_date managed_by relationship_to_manager primary_household_id permissions preferences is_ai created_at updated_at }"#
    }
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      ...
      .field("permissions", PantryGraphQL.JSON?.self),
      .field("preferences", PantryGraphQL.JSON?.self),
