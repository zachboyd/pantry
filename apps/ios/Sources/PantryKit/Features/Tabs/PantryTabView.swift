/*
 ...
 Pantry tab placeholder with nice empty state
 */

import SwiftUI

/// Pantry tab view with placeholder content
public struct PantryTabView: View {
    @Environment(\.safeViewModelFactory) private var factory
    @State private var viewModel: PantryTabViewModel?
    ...
    @ViewBuilder
    private func pantryContent(viewModel: PantryTabViewModel) -> some View {
        ZStack {
    ...
    @ViewBuilder
    private func pantryItemsList(viewModel: PantryTabViewModel) -> some View {
        List {
    ...
    private func loadViewModel() async {
        ...
        do {
            let newViewModel = try factory.makePantryTabViewModel()
