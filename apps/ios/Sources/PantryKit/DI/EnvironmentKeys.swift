...
private struct PantryItemServiceKey: EnvironmentKey {
    static let defaultValue: (any PantryItemServiceProtocol)? = nil
}
...
public extension EnvironmentValues {
    ...
    /// Pantry item service for pantry management (optional for safe access)
    var pantryItemService: (any PantryItemServiceProtocol)? {
        get { self[PantryItemServiceKey.self] }
        set { self[PantryItemServiceKey.self] = newValue }
    }
