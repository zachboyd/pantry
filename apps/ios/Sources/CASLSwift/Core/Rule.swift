...
public extension Rule {
    ...
    func matches(action: Action, subjectType: SubjectType) -> Bool {
    ...
    func matchesAction(_ action: Action) -> Bool {
    ...
    func matchesSubjectType(_ subjectType: SubjectType) -> Bool {
        // "all" or "any" subject types match everything
        if subject == .all || subject == .any {
            return true
        }
