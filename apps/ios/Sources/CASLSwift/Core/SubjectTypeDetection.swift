...
public struct ProtocolBasedSubjectTypeDetector: SubjectTypeDetector {
    ...
    public init(
        ...
        self.protocolMappings = mappings.map { typePattern, subjectType in
    ...
    public init(
        ...
        self.protocolMappings = checks.map { check, subjectType in
...
extension Subject {
    ...
    public static func subjectType() -> SubjectType {
