...
This directory contains the Apollo GraphQL client integration for the Jeeves iOS app.
...
- **Input Types**: `JeevesGraphQL.CreateHouseholdInputGql`
...
private func mapGraphQLHouseholdToDomain(
    _ graphqlHousehold: JeevesGraphQL.UpdateHouseholdMutation.Data.UpdateHousehold
) -> Household {
    return Household(
