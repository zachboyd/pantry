...
public extension Household {
    ...
    static let mock = Household(
        id: LowercaseUUID(uuidString: "11111111-1111-1111-1111-111111111111")!,
        name: "The Smith Family",
        description: "Our main family household for daily groceries and meal planning",
        createdBy: LowercaseUUID(uuidString: "22222222-2222-2222-2222-222222222222")!,
    ...
    static let mock2 = Household(
        id: LowercaseUUID(uuidString: "33333333-3333-3333-3333-333333333333")!,
        name: "Beach House",
